		...
		<div class="col-md-12 ">
			...
			<div class="grid-form">
				...
				<div class="grid-form1">
					...
					<form name="input_data" class="ketua-form" action="proses-add-finance.php" method="post" enctype="multipart/form-data">
						<div class="col-md-12 form-group2 group-mail">
							<label class="control-label">Nama Finance</label>
							<input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Finance" required>
						</div>
						<div class="col-md-12 form-group2 group-mail">
